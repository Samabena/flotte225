...
class ReportSchedule(Base):
    ...
    frequency: Mapped[str | None] = mapped_column(String(20), nullable=True)  # weekly | monthly
    last_sent_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    last_status: Mapped[str | None] = mapped_column(String(20), nullable=True)  # sent | failed
    ai_reports_used_month: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
